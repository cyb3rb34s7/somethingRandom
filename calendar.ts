// modern-date-time-picker.component.ts
  ...
  template: `
    <div class="modern-date-time-picker">
      <mat-form-field appearance="outline">
        ...
        <input matInput [value]="formattedDateTime" readonly (click)="picker.open()">
...
export class ModernDateTimePickerComponent implements ControlValueAccessor, OnInit {
  ...
  updateDateTime(): void {
    ...
    this.formattedDateTime = this.formatDateTime(dateTime);
    this.onChange(this.formattedDateTime);
    this.onTouched();
  }
